...
public class Tutorial : MonoBehaviour
{
    private static string[] texts =
    {
        ...
        "Вкладки выдачи заданий - выберете одно из доступных заданий для вашего агента. Чем выше ключевой навык вашего агента, тем выше шансы на успех (он выделен цветом на правой странице)",
